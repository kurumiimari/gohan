...
func TestOpcodeDisasm(t *testing.T) {
	...
	expectedStrings := [256]string{0x00: "0", 0x4f: "-1",
		...
		0xc0: "OP_BLAKE160", 0xc1: "OP_BLAKE256", 0xc2: "OP_SHA3", 0xc3: "OP_KECCAK",
		0xd0: "OP_TYPE",
	...
	for opcodeVal, expectedStr := range expectedStrings {
		...
		// OP_UNKNOWN#.
		case opcodeVal >= 0xba && opcodeVal <= 0xbf ||
			opcodeVal >= 0xc4 && opcodeVal <= 0xcf ||
			opcodeVal >= 0xd1 && opcodeVal <= 0xfe:
